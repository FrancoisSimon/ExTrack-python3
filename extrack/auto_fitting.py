...
def fit_2states(all_Cs,
    ...
    model_fit = get_2DSPT_params(all_Cs, dt, nb_substeps = 1, states_nb = 2, do_frame = 1,frame_len = 4,cell_dims = cell_dims, verbose = 0, vary_params = vary_params, estimated_vals = estimated_vals, steady_state = steady_state)
    ...
    for kk in range(40):
        if keep_running:
            ...
            model_fit = get_2DSPT_params(all_Cs, dt, nb_substeps = nb_substeps, states_nb = 2, do_frame = 1,frame_len = frame_len,cell_dims = cell_dims, verbose = 0, vary_params = vary_params, estimated_vals = estimated_vals, steady_state = True)
...
def fit_3states(all_Cs,
    ...
    preds = predict_Bs(all_Cs, dt, params = model_fit.params, states_nb = 3, frame_len = 7)
    return model_fit, preds
