...
setup(
    ...
    description='A library to quantify diffusion and transition rates of SPT tracks in multiple states',
    ...
    keywords='SPT kinetic modelling and states annotation of tracks',
    ...
    install_requires=['numpy', 'itertools', 'lmfit', 'cupy'],
